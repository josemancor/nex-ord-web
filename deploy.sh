#!/bin/bash
# ------------------------------------------------------------------------------
# NEXORD WEB DEPLOYMENT SCRIPT (Strict Rule 4)
# Sincroniza desde NEXORD_Project/05_Web_Promocional hacia SOC_ORD_WEB y publica en GitHub Pages.
# ------------------------------------------------------------------------------
...
git commit -m "Auto-deploy: $TIMESTAMP - VISORD & NEXORD Web sync" || true
